...
QUERIES = [
   ...
   ("Análisis comparativo de las mejores escuelas de formación audiovisual en España.", "The Core School", "Competition & Benchmarking", "es"),
   ...
   # MARKETING Y CANALES
   ("¿Qué canales digitales son más efectivos para llegar a jóvenes interesados en audiovisual en España?", "The Core School", "Digital Trends & Marketing", "es"),
